...
message = "Cordial saludo; \n\nEl ETL procedimiento GYGPROPS.SPCREDET() correspondiente al ETL detalle productos vehículos para la fecha: "+fecha_actual
...
msg['Subject'] = "IMPORTANTE: FALLA EN ETL DETALLE PRODUCTOVH "+fecha_actual
